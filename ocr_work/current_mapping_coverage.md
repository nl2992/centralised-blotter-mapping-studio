...
| Structured FI - Credit | Same Structured FI mapping as Rate, with tier 3 default `Structured Credit`. | Coverage/legal/PC reference-driven fields; Secondary CCY; 2025/2026 Buy/Sell if no `New/Tap/Sell` column. |
| Structured FI - FX | Same Structured FI mapping as Rate, with tier 3 default `Structured FX`. | Coverage/legal/PC reference-driven fields; Secondary CCY; 2025/2026 Buy/Sell if no `New/Tap/Sell` column. |
| Structured FI - Unknown | Same Structured FI mapping, but classification is inferred from `Product`, `Underlying`, and `Structure`. CLN text now maps to Structured Credit / Structured Credit / Credit Linked Notes. | Product reference/rules required for other unknown taxonomy; coverage/legal/PC reference-driven fields. |
